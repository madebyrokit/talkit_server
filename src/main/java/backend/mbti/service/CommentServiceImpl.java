...
public class CommentServiceImpl implements CommentService {
    ...
    public List<CommentDto.GetResponse> getComments(Long postId) {
        ...
        List<Comment> comment = commentRepository.findAllByPostIdOrderByIdDesc(postId);
        ...
        for (Comment comment1 : comment) {
            CommentDto.GetResponse v = new CommentDto.GetResponse(
                    ...
                    comment1.getMember().getProfileImage().getStoreFileName(),
    ...
    public Long toggleLike(Long commentId, String username) {
        ...
        Optional<LikeComment> optionalLikeComment = likeCommentRepository.findByMemberIdAndCommentId(member.getId(), comment.getId());
